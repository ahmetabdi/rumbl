defmodule Rumbl.VideoControllerTest do
  ...
  @valid_attrs %{url: "http://youtube.be", title: "Video", description: "A description"}
  ...
  test "lists all user's videos on the index", %{conn: conn, user: user} do
    user_video = insert_video(user, title: "Cats")
    new_user = insert_user(username: "john")
    other_video = insert_video(new_user, title: "Dogs")
